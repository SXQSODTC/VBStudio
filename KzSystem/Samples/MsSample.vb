...
Public Class ListViewOwnerDraw
    ...
    Private Sub menuItemList_Click(ByVal sender As Object,
    ...
    Private Sub menuItemDetails_Click(ByVal sender As Object,
        ByVal e As EventArgs) _
    ...
    Private Sub listView1_DrawItem(ByVal sender As Object,
        ...
        Else
            ...
            Dim brush As New LinearGradientBrush(e.Bounds, Color.Orange,
    ...
    Private Sub listView1_DrawSubItem(ByVal sender As Object,
    ...
    Private Sub listView1_Invalidated(ByVal sender As Object,
    ...
    Private Sub listView1_ColumnWidthChanged(ByVal sender As Object,
